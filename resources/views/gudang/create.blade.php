...
<div class="max-w-2xl mx-auto">
    ...
    <div class="neo-brutal-card p-8 bg-white space-y-6">
        <div class="border-b-3 border-black pb-4">
            <h3 class="text-xl font-black text-black">Formulir Pendaftaran Gudang Baru</h3>
        ...
        <form action="{{ route('gudang.store') }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <select id="status_gudang" name="status_gudang" class="neo-brutal-input" required>
                    ...
                    <option value="nonaktif" {{ old('status_gudang') === 'nonaktif' ? 'selected' : '' }}>Nonaktif (Tutup)</option>
                </select>
