...
<div class="max-w-2xl mx-auto">
    ...
    <div class="neo-brutal-card p-8 bg-white space-y-6">
        <div class="border-b-3 border-black pb-4">
            <h3 class="text-xl font-black text-black">Formulir Perbarui Data Staff</h3>
        ...
        <form action="{{ route('admin.update', $admin->id_admin) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                    <label for="password" class="block font-black text-sm text-black">Ganti Password</label>
