        ...
        <form action="{{ route('kurir.update', $kurir->id_kurir) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="text" id="kendaraan" name="kendaraan" class="neo-brutal-input" value="{{ old('kendaraan', $kurir->kendaraan) }}" required placeholder="Contoh: Sepeda Motor, Mobil Box, Tossa">
